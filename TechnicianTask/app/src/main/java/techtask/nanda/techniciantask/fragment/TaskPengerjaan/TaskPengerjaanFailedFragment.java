...
public class TaskPengerjaanFailedFragment extends BaseFragment {
    ...
    public TaskPengerjaanFailedFragment() {
    ...
    // Inisialisasi awal
    private void init() {
        requestTaskFailedList();
    }

    // Data dummy untuk Task Done
    private void requestTaskFailedList() {
    ...
    private void getTaskPengerjaan(final String id_teknisi) {
        ...
        Call<TaskPengerjaanResponse> call = apiInterface.callTaskWoByIdTeknisi(id_teknisi, "3");
        call.enqueue(new Callback<TaskPengerjaanResponse>() {
            ...
            public void onResponse(Call<TaskPengerjaanResponse> call, Response<TaskPengerjaanResponse> response) {
                ...
                Log.d(TAG, "API response get task pengerjaan FAILED. Code: " + response.code());
