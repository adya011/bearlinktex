...
public class RTaskDetailImageDisabledAdapter extends RecyclerView.Adapter<RTaskDetailImageDisabledAdapter.ViewHolder> {
    private List<RTaskReportPhoto> taskList;
    private Activity activity;

    public RTaskDetailImageDisabledAdapter(List<RTaskReportPhoto> taskList, Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_task_image_not_avail, parent, false);
